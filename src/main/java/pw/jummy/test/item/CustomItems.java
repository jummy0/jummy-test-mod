...
public class CustomItems {
	public static final Item GRAVEL_BITS = new Item(new FabricItemSettings()
		...
		.food(new FoodComponent.Builder()
			...
			.statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 30, 19), 1.0f)
			.statusEffect(new StatusEffectInstance(StatusEffects.POISON, 20, 1), 0.125f)
			.build()));
	...
	public static final Item CHEESE = new Item(new FabricItemSettings()
		...
		.food(new FoodComponent.Builder()
			...
			.build()));
	public static final Item BLUE_CHEESE = new Item(new FabricItemSettings()
		.group(ItemGroup.FOOD)
		.food(new FoodComponent.Builder()
			.hunger(1)
			.saturationModifier(0.5f)
			.build()));
	public static final Item STRING_CHEESE = new Item(new FabricItemSettings()
		.group(ItemGroup.FOOD)
		.food(new FoodComponent.Builder()
			.hunger(1)
			.saturationModifier(0.6f)
			.build()));
	public static final Item CHEESE_STICK = new Item(new FabricItemSettings()
		.group(ItemGroup.FOOD)
		.food(new FoodComponent.Builder()
			.hunger(1)
	...
	public static final Item HAMBURGER = new Item(new FabricItemSettings()
		...
		.food(new FoodComponent.Builder()
			...
			.saturationModifier(1.5f)
			.build()));
	public static final Item DORITOS = new DoritosItem(new FabricItemSettings()
		.group(ItemGroup.FOOD)
		.food(new FoodComponent.Builder()
			.hunger(5)
			.saturationModifier(1.0f)
			.build()));
	public static final Item DORITOS_DUST = new Item(new FabricItemSettings()
		.group(ItemGroup.MISC)
		.maxCount(1));
	...
	public static final Item WOOD_NUGGET = new Item(new FabricItemSettings()
		.group(ItemGroup.MISC));
	...
	public static final ToolItem OBSIDIAN_HOE = new CustomHoeItem(
		...
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem COPPER_SWORD = new SwordItem(
		CopperToolMaterial.INSTANCE,
		3, // 3 + 1 + 1 = 5 HP
		-2.4f, // 4 - 2.4 = 1.6 Hz
		new FabricItemSettings()
			.group(ItemGroup.COMBAT));
	public static final ToolItem COPPER_SHOVEL = new ShovelItem(
		CopperToolMaterial.INSTANCE,
		2f, // 2 + 1 + 1 = 4 HP
		-3.0f, // 4 - 3 = 1 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem COPPER_PICKAXE = new CustomPickaxeItem(
		CopperToolMaterial.INSTANCE,
		1, // 1 + 1 + 1 = 3 HP
		-2.8f, // 4 - 2.8 = 1.2 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem COPPER_AXE = new CustomAxeItem(
		CopperToolMaterial.INSTANCE,
		7, // 7 + 1 + 1 = 9 HP
		-3.15f, // 4 - 3.15 = 0.85 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem COPPER_HOE = new CustomHoeItem(
		CopperToolMaterial.INSTANCE,
		0, // 0 + 1 + 1 = 2 HP
		-1.5f, // 4 - 1.5 = 2.5 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem THICK_COPPER_SWORD = new SwordItem(
		CopperBlockToolMaterial.INSTANCE,
		3, // 3 + 1 + 1 = 5 HP
		-2.8f, // 4 - 2.8 = 1.2 Hz
		new FabricItemSettings()
			.group(ItemGroup.COMBAT));
	public static final ToolItem THICK_COPPER_SHOVEL = new ShovelItem(
		CopperBlockToolMaterial.INSTANCE,
		2f, // 2 + 1 + 1 = 4 HP
		-3.25f, // 4 - 3.25 = 0.75 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem THICK_COPPER_PICKAXE = new CustomPickaxeItem(
		CopperBlockToolMaterial.INSTANCE,
		1, // 1 + 1 + 1 = 3 HP
		-3.1f, // 4 - 3.1 = 0.9 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem THICK_COPPER_AXE = new CustomAxeItem(
		CopperBlockToolMaterial.INSTANCE,
		7, // 7 + 1 + 1 = 9 HP
		-3.3625f, // 4 - 3.3625 = 0.6375 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem THICK_COPPER_HOE = new CustomHoeItem(
		CopperBlockToolMaterial.INSTANCE,
		0, // 0 + 1 + 1 = 2 HP
		-2.125f, // 4 - 2.125 = 1.875 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	...
	public static final ToolItem DIRT_HOE = new CustomHoeItem(
		...
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem END_STONE_SWORD = new SwordItem(
		EndStoneToolMaterial.INSTANCE,
		4, // 4 + 0 + 1 = 5 HP
		-2.4f, // 4 - 2.4 = 1.4 Hz
		new FabricItemSettings()
			.group(ItemGroup.COMBAT));
	public static final ToolItem END_STONE_SHOVEL = new ShovelItem(
		EndStoneToolMaterial.INSTANCE,
		2.5f, // 2.5 + 0 + 1 = 3.5 HP
		-3.0f, // 4 - 3 = 1 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem END_STONE_PICKAXE = new CustomPickaxeItem(
		EndStoneToolMaterial.INSTANCE,
		2, // 2 + 0 + 1 = 3 HP
		-3.0f, // 4 - 3 = 1 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem END_STONE_AXE = new CustomAxeItem(
		EndStoneToolMaterial.INSTANCE,
		8, // 8 + 0 + 1 = 9 HP
		-3.2f, // 4 - 3.2 = 0.8 Hz
		new FabricItemSettings()
			.group(ItemGroup.TOOLS));
	public static final ToolItem END_STONE_HOE = new CustomHoeItem(
		EndStoneToolMaterial.INSTANCE,
		0, // 0 + 0 + 1 = 1 HP
		-2.0f, // 4 - 2 = 2 Hz
		new FabricItemSettings()
	...
	public static final Item BALL_BUCKET = new BallBucketItem(
		CustomBlocks.BALLS,
		CustomSoundEvents.BALL_BUCKET_FILL,
		new Item.Settings()
			.maxCount(1)
			.group(ItemGroup.MISC));
